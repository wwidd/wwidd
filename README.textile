...
*yalp* is a _browser-based, offline video tagger_, for organizing, searching, and playing back your existing collection.
...
h3. Normal installation on Windows, Linux, OS X (never tested on Mac)
