 ...
 * Media Tagger Widget
 *
 * Contains a collection of tag widgets.
 */
...
app.widgets = function (widgets, $, wraith, jOrder, model) {
    ...
    widgets.tagger = function (mediaid) {
        ...
        /**
         * Compares tag entries for sorting.
         * @param a {object} Tag entry.
         * @param a.kind {string} Tag kind.
         * @param a.name {string} Tag name.
         * @param b {object} Tag entry.
         * @param b.kind {string} Tag kind.
         * @param b.name {string} Tag name.
         */
     ...
     * @param [force] {boolean} Whether to force resizing. (Discarding actual size differences.)
     * @param [elem] {object} custom jQuery object to use instead of tagger widgets.
     */
    ...
    /**
     * Rebuilds and re-renders all visible tagger widgets.
     */
